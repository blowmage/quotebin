class SearchController < ApplicationController
  ...
  def autocomplete
    ...
    if results.total_count > 0
      ...
      payload << { value: query, label: "<strong class='b'>Add quote:</strong> <em class='em js-add-quote-from-search'>\"#{query}\"</em>".html_safe, url: "javascript:window.openQuoteEditor();" }
      # Note: was new_quote_path
    end
